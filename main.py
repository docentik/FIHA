#!/usr/bin/env python
### Author: Stanislav PetrÌk fiha-st
...
<table border=0>
 ...
 <td><image src="/images/look.jpg" width="40" hspace="10"></td>
...
def write_page_header(self):
  ...
  self.response.out.write('''
     ...
     <head>
     <style type="text/css">
        body {background-color:black;font-size:20px;margin-left: 5% ; margin-right: 5%; margin-top: 0px;
             font-family: verdana, arial,"trebuchet ms", helvetica, sans-serif;}
        button {font-size:30px; background-color:silver;}
        h3 {color:gray; margin-top: 5px;}
        table {font-family: Arial; border: 3px solid dimgray; padding: 3px; border-spacing: 3px; margin-bottom: 3px;}
        th {font-size:35px;color: white;border: 3px solid darkgray; padding: 10px; cellspacing:20px;}
        td {font-size:25px; color: silver; border: 1px solid darkgray;text-align:center; padding: 10px;}
        ul {list-style: disc;}
        p { margin-top: 0px; margin-bottom: 0px; font-size:20px;}
     </style>
     <title><h6>Tiny WebDB</h6></title>
     </head>
     <body>''')
